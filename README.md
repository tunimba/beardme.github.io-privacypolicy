...
Beardio ("Beardio", "we", "us", or "our") is committed to protecting your privacy. This Privacy Policy applies to Beardio and its various versions and is part of our Terms of Use. By accessing or using our Application, you acknowledge and fully understand this Privacy Policy and freely consent to the practices described here.
...
You may upload or capture photos solely for AI-powered beard addition, mustache addition, beard style simulation, and facial hair transformations. Photos are sent temporarily to our AI provider for processing and are automatically discarded once the transformation is complete. We do not store, extract, or analyze facial features for identification or profiling purposes.
...
This section describes in detail how Beardio handles face data in compliance with Apple's App Store Review Guidelines (5.1.1).

### What face data does the app collect?

Beardio does not collect, store, or retain any face data. Photos you upload may contain faces, but the app does not extract, analyze, or store any facial features, biometric identifiers, or face geometry data. The uploaded photo is processed as a whole image; no face-specific data is isolated or recorded at any point.

### How is face data used?

Photos containing faces are used solely to provide AI-powered beard addition, mustache addition, beard style simulation, and facial hair transformations. The processing is entirely automated by AI models that apply visual transformations to the image. The app does not perform facial recognition, face mapping, identity analysis, or any form of biometric identification. No face data is used for advertising, profiling, or any purpose beyond delivering the requested transformation.
...
- Temporary processing: Uploaded photos are sent to our third-party AI provider, Replicate, Inc., for AI-powered beard and mustache transformations.
...
- No human review: All processing is handled by automated AI models.
...
AIProxy — Secure AI routing  
Apple In-App Purchases — Payments

None of the data collected is linked to your identity.

## 6. Data Retention

Photos: Not stored. Deleted after processing.  
Face data: Not retained.  
Analytics: Anonymous only.  
Purchase data: Managed by Apple and RevenueCat.  
No user data linked to identity.
...
Beardio is not designed for users under age 4.  
Contact: tunahanaktay.apps@gmail.com
